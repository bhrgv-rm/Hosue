...
<header>
    <div class="header-area homepage9 header header-sticky d-none d-lg-block " id="header">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="header9-top-area">
                        <p>Are you Visit in Diamond Property? <a href="contact.php"> Contact Us</a></p>
                        <ul>
                ...
                <div class="col-lg-12">
                    <div class="header-elements">
                        <div class="site-logo">
                            <a href="index.php"><img src="/assets/img/logo/logo9.png" alt=""></a>
                        </div>
                        <div class="main-menu">
                            <ul>
                                                ...
                                                <div class="all-images-menu">
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index1.php" target="_blank">One Page</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index2.php"> Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index2.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index3.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index3.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index4.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index4.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb" style="margin: 0;">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index5.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index5.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                ...
                                                <div class="all-images-menu">
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index6.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index6.php" target="_blank">One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index7.php"> Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index7.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index8.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index8.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index9.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index9.php" target="_blank"> One Page </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb" style="margin: 0;">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn10" href="index10.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn10" href="single-index10.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <li><a href="#">Apartment <i class="fa-solid fa-angle-down"></i></a>
                                    <ul class="dropdown-padding">
                                        <li class="menu-small"><a href="#">Our Apartment <i class="fa-solid fa-angle-right"></i></a>
                                            <ul class="small-menu">
                                                <li><a href="apartment-v1.php">Apartment V1</a></li>
                                                <li><a href="apartment-v2.php">Apartment V2</a></li>
                                                <li><a href="apartment-v3.php">Apartment V3</a></li>
                                                <li><a href="apartment-v4.php">Apartment V4</a></li>
                                                <li><a href="apartment-v5.php">Apartment V5</a></li>
                                                <li><a href="apartment-v6.php">Apartment V6</a></li>
                                            </ul>
                                        </li>
                                        <li class="menu-small"><a href="service2.php">Single Apartment <i class="fa-solid fa-angle-right"></i></a>
                                            <ul class="small-menu">
                                                <li><a href="apartment-left.php">Details Left</a></li>
                                                <li><a href="apartment-right.php">Details Right</a></li>
                                                <li><a href="apartment-single.php">Details Single</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li><a href="#">Pages <i class="fa-solid fa-angle-down"></i></a>
                                    <ul class="dropdown-padding">
                                        <li><a href="gallery-v1.php">Gallery V1</a></li>
                                        <li><a href="gallery-v2.php">Gallery V2</a></li>
                        ...
                        <div class="btn-area">
                            ...
                            <a href="contact.php" class="header-btn10">Schedule A Visit</a>
                        </div>
...
<div class="mobile-sidebar mobile-sidebar9">
    ...
    <div class="mobile-nav mobile-nav1">
        ...
        <div class="allmobilesection">
            <a href="contact.php" class="header-btn10">Get Started <span><i class="fa-solid fa-arrow-right"></i></span></a>

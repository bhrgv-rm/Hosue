                                                ...
                                                <div class="all-images-menu">
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index1.php" target="_blank">One Page</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index2.php"> Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index2.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index3.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index3.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index4.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index4.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb" style="margin: 0;">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index5.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index5.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                ...
                                                <div class="all-images-menu">
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index6.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index6.php" target="_blank">One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index7.php"> Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index7.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index8.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index8.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index9.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index9.php" target="_blank"> One Page </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb" style="margin: 0;">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn3" href="index10.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn3" href="single-index10.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn7" href="index.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index1.php" target="_blank">One Page</a>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                ...
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index2.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                ...
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index3.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                ...
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index4.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb" style="margin: 0;">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                ...
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index5.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                        <div class="space20"></div>
                                                    </div>
                                                ...
                                                <div class="all-images-menu">
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn7" href="index6.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index6.php" target="_blank">One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn7" href="index7.php"> Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index7.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn7" href="index8.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index8.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn7" href="index9.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index9.php" target="_blank"> One Page </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="images">
                                                        <div class="homemenu-thumb" style="margin: 0;">
                                                            ...
                                                            <div class="homemenu-btn">
                                                                <a class="header-btn7" href="index10.php">Multi Page</a>
                                                                <div class="space16"></div>
                                                                <a class="header-btn7" href="single-index10.php" target="_blank"> One Page</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
<div class="mobile-sidebar mobile-sidebar6">
    ...
    <div class="mobile-nav mobile-nav1">
        ...
        <div class="allmobilesection">
            <a href="contact.php" class="header-btn7">Get Started <span><i class="fa-solid fa-arrow-right"></i></span></a>

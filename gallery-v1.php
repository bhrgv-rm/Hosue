...
<body class="homepage3-body">
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="inner-heading header-heading">
            <h2>Our Gallery V1</h2>
            <div class="space24"></div>
            <p><a href="index.php">Home <i class="fa-solid fa-angle-right"></i></a> <a href="blog.php'"> Our Gallery V1</a></p>
          </div>
        </div>
  ...
  <!--===== GALLERY AREA STARTS =======-->
  <div class="gallery-inner-section-area sp6">
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6">
          <div class="apartment-boxarea">
            ...
            <div class="arrow">
              <a href="apartment-v1.php">View</a>
            </div>
          </div>
        </div>
